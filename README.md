...
## Sơ Đồ Cấu Trúc & Luồng Hoạt Động (Architecture & Flowchart)
...
1.  **Chọn Khung Hình:** Bấm vào nút menu góc trái (trên điện thoại) hoặc xem trực tiếp menu ở cột trái (trên máy tính) để chọn 1 trong 11 layout yêu thích.
...
*Chúc bạn tạo ra thật nhiều dải ảnh kỷ niệm Apeach dễ thương và đáng nhớ!*
